...
// Perform an data call to the Citi bike data to get station information. Call createMarkers when complete (this is a pretend file, need real file)
...
function createMarkers(response) {
  ...
  bikeMarkers = L.layerGroup(bikeMarkers);
